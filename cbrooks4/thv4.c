...
void printOutput(Node* aNode) { 
    ...
    p1strcat(path, "/proc/");
    p1itoa(aNode->pid, aBuff);
    p1strcat(path, aBuff);
    p1strcat(path, "/status");
    char * secondBuff = malloc(sizeof(char)*1024);
    secondBuff[0] = '\0';
    int file;
    ...
    p1putstr(1, "process: ");
    p1putint(1, aNode->pid);
    p1putstr(1, "\n");
    p1putstr(1, path);
    p1putstr(1, "\n");
    p1putstr(1, "This is the name of the process\n");
    p1getline(file,secondBuff,1024);
    p1putstr(1, secondBuff);
    p1putstr(1, "This is the state of the process\n");
    p1getline(file,secondBuff,1024);
    p1putstr(1, secondBuff);
    close(file);
    free(path);
    ...
    p1putstr(1, "This is the execution process\n");
    p1getline(file,secondBuff,1024);
    p1putstr(1, secondBuff);
    p1putstr(1, "\n");
    close(file);
    ...
    p1putstr(1, "This is how many chars were read\n");
    p1getline(file,secondBuff,1024);
    p1putstr(1, secondBuff);
    p1putstr(1, "This is how many chars were written\n");
    p1getline(file,secondBuff,1024);
    p1putstr(1, secondBuff);
    p1putstr(1, "\n");
